...
!meson and quark anomanous dimension
  ...
  real(16) l_com,lb_com,k_value1
  real(16) cyukawa,hbare
  ...
  common /kvalue_com/ k_value1
  common /yukawaparameter/ cyukawa
  common /hcouple/ h
  ...
  call fityukawa(k*hc,hbare)
  h=hbare/(sqrt(Zphi)*Zpsi)*cyukawa
...
!  dydx((Nv+1)+1)=dhdt
  ...
  if(k<k_value1)then
    ...
    write(*,"('k=', f15.7, t25, 'mPion=', f15.7)")k*hc,sqrt(mp2)*hc*k
    write(*,"('mf=', f15.7, t25, 'mSigma=', f15.7)")sqrt(mf2)*hc*k,sqrt(ms2)*hc*k

  open(unit=100,file='./buffer/mf.dat')
  write(100, "(e20.9)")sqrt(mf2)*hc*k

  open(unit=101,file='./buffer/k1.dat')
  write(101, "(e20.9)")k*hc

  open(unit=102,file='./buffer/Zphi.dat')
  write(102, "(e20.9)")Zphi

  open(unit=103,file='./buffer/Zpsi.dat')
  write(103, "(e20.9)")Zpsi

  open(unit=104,file='./buffer/hbar.dat')
  write(104, "(e20.9)")h

  open(unit=105,file='./buffer/h.dat')
  write(105, "(e20.9)")h*sqrt(Zphi)*Zpsi

  open(unit=106,file='./buffer/mpi.dat')
  write(106, "(e20.9)")sqrt(mp2)*hc*k

  open(unit=107,file='./buffer/msigma.dat')
  write(107, "(e20.9)")sqrt(ms2)*hc*k

  open(unit=108,file='./buffer/sigma.dat')
  write(108, "(e20.9)")sqrt(2*rho)*hc
