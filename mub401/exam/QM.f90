...
!order of chebyshev polynomial
  ...
  open(unit=1,file='../para/p0.dat')
  read(1,*) p0data
  close (1)

  open(unit=1,file='../para/p1.dat')
  read(1,*) p1data
  close (1)

  open(unit=1,file='../para/p2.dat')
  read(1,*) p2data
  close (1)

  open(unit=1,file='../para/p3.dat')
  read(1,*) p3data
  close (1)

  open(unit=1,file='../para/p4.dat')
  read(1,*) p4data
  close (1)

  open(unit=1,file='../para/p5.dat')
  read(1,*) p5data
  close (1)

  open(unit=1,file='../para/p6.dat')
  read(1,*) p6data
  close (1)

  open(unit=1,file='../para/p7.dat')
  read(1,*) p7data
  close (1)

  open(unit=1,file='../para/p8.dat')
  read(1,*) p8data
  close (1)

  open(unit=1,file='../para/p9.dat')
  read(1,*) p9data
  close (1)
